...
exports.uploadedUserPhoto = upload.fields(
   [
...
// /tours-within/:distance/center/:laglng/unit/:unit'
// /tours-within/distance/233/center/34.119560, -118.133999/unit/mi
...
//    if (!tour) return next(new AppError('Not tour found with this ID', 404))
